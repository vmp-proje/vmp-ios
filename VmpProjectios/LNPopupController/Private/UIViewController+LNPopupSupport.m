...
{
//  [self._ln_popupController_nocreate dismissPopupBarAnimated:<#(BOOL)#> duration:<#(CGFloat)#> completion:^{
//  }
//   ]
  [self._ln_popupController_nocreate dismissPopupBarAnimated:animated duration: duration completion:^{
		//Cleanup
		self.popupContentViewController.popupPresentationContainerViewController = nil;
		self.popupContentViewController = nil;
