...
class MusicPlayerViewController<V: BaseMusicPlayerView>: LNPopupCustomBarViewController, NVActivityIndicatorViewable, DownloadButtonProtocol, MusicPlayerCommunicationProtocol {
